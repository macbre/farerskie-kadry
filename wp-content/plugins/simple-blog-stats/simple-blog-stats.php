...
function sbs_posts($attr, $content = null) {
	...
	return $sbs_options['count_posts_before'] . $count . $sbs_options['count_posts_after'];
...
function sbs_pages() {
	...
	return $sbs_options['count_pages_before'] . $count . $sbs_options['count_pages_after'];
...
function sbs_drafts() {
	...
	return $sbs_options['count_drafts_before'] . $count . $sbs_options['count_drafts_after'];
...
function sbs_comments() {
	...
	return $sbs_options['count_comments_before'] . $count . $sbs_options['count_comments_after'];
...
function sbs_moderated() {
	...
	return $sbs_options['count_moderated_before'] . $count . $sbs_options['count_moderated_after'];
...
function sbs_approved() {
	...
	return $sbs_options['count_approved_before'] . $count . $sbs_options['count_approved_after'];
...
function sbs_users() {
	...
	return $sbs_options['count_users_before'] . $count . $sbs_options['count_users_after'];
...
function sbs_word_count_all($wrap) {
	...
	$posts = get_posts(array('post_type' => 'any', 'post_status' => 'publish', 'posts_per_page' => $limit));
...
function add_sbs_links($links, $file) {
	if ($file == plugin_basename(__FILE__)) {
		...
		$links[] = '<a target="_blank" rel="noopener noreferrer" href="'. $url .'" title="'. $title .'">'. $text .'</a>';
	}
	return $links;
}
...
function sbs_render_form() {
	...
	<style type="text/css">
		...
		.sbs-checkbox th, .sbs-checkbox td { padding-top: 20px; padding-bottom: 20px; }
		.sbs-checkbox input { position: relative; top: -2px; }
