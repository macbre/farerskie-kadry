			...
			<?php foreach ($blogs->items as $blog) : ?>
				<div class="blog media-item" data-id="<?php echo $blog->id; ?>">
					...
					<div class="done wp-filter">
						...
						<!--<p>1. <?php _e("This plugin will redirect any old Blogger links to the new WordPress structure. Keep it installed and active on this site.", BIECore::SLUG); ?></p>-->
						<p>2. <?php printf(__('Has this free plugin helped you? Please consider <a href="%s" target="_blank">leaving a review</a> - thanks :)', BIECore::SLUG), 'https://wordpress.org/support/plugin/blogger-importer-extended/reviews/#new-post'); ?></p>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
