...
if ( ! function_exists( 'lovecraft_setup' ) ) {
	...
	function lovecraft_setup() {
		...
		add_image_size( 'post-image-cover', 1920, 9999 );
...
if ( ! function_exists( 'lovecraft_load_style' ) ) {
	...
	function lovecraft_load_style() {
		if ( ! is_admin() ) {
			...
			if ( 'off' !== $google_fonts ) {
				wp_register_style( 'lovecraft_googlefonts', '//fonts.googleapis.com/css?family=Lato:400,700,900|Playfair+Display:400,700,400italic|Spectral:300,300i&subset=latin-ext' );
...
if ( ! function_exists( 'lovecraft_add_editor_styles' ) ) {
	...
	function lovecraft_add_editor_styles() {
		...
		if ( 'off' !== $google_fonts ) {
			$font_url = '//fonts.googleapis.com/css?family=Lato:400,700,900|Playfair+Display:400,700,400italic|Spectral:300,300i&subset=latin-ext';
...
if ( ! function_exists( 'lovecraft_modify_read_more_link' ) ) {
	...
	function lovecraft_modify_read_more_link() {
		return '<p><a class="more-link" href="' . get_permalink() . '">Czytaj dalej</a></p>';
	}
